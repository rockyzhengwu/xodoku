...
pub(crate) fn find_steps(
    ...
    for ur in rectangles {
        ...
        if add_unique_step(grid, ur2, seen_removals, acc) {
            return;
        }
    }
}
...
mod test {
    ...
    fn test_unique_type2() {
        let _s = ":0601:8:+46+95..2+711+8+5+7+6+2+4+3+9+7239..+8+5664+7+8+5+9+3+1+2+3+1+8+427+69+5+952..+6+78+4..+4.+9.+56...1+6.59..5+9+6.7.1..::899:";
