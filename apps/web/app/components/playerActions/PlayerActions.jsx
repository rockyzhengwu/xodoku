      ...
      children: (
        <>
          <Stack>
            ...
            <p className="break-all font-mono text-sm">{originalLine}</p>
            <Button
              onClick={() => {
            ...
            <p className="break-all font-mono text-sm">{singleLine}</p>
            <Button
              onClick={() => {
            ...
            <pre className="overflow-x-auto text-xs">{gridContent}</pre>
            <Button
              onClick={() => {
    ...
    modals.open({
      ...
      children: (
        <>
          ...
          <pre className="overflow-x-auto text-xs">{sampleGridExample}</pre>
          <Textarea
            data-autofocus
