use crate::{
    ...
    solver::{
        ...
        unique_1::UniqueType1, unique_2::UniqueType2, unique_3::UniqueType3, unique_4::UniqueType4,
        unique_5::UniqueType5, unique_6::UniqueType6, wwing::WWing, xywing::XYWing,
    },
};
...
impl Step {
    ...
    pub fn name(&self) -> &str {
        match self {
            Step::FullHouse(_) => "FullHouse",
            Step::NakedSingle(_) => "NakedSingle",
            Step::HiddenSingle(_) => "HiddenSingle",
            Step::HiddenSet(hs) => "HiddenSet",
            Step::LockedCandidate(_) => "LockedCandidate",
            Step::NackedSet(ns) => "NakedSet",
            Step::Fish(fish) => fish.name(),
            Step::Skyscraper(_) => "Skyscraper",
            Step::TwoStringKit(_) => "TwoStringKit",
            Step::EmptyRectangle(_) => "EmptyRectangle",
            Step::UniqueType1(_) => "UniqueType1",
            Step::UniqueType2(_) => "UniqueType2",
            Step::UniqueType3(_) => "UniqueType3",
            Step::UniqueType4(_) => "UniqueType4",
            Step::UniqueType5(_) => "UniqueType5",
            Step::UniqueType6(_) => "UniqueType6",
            Step::HiddenRectangle(_) => "HiddenRectangle",
            Step::BugPlusOne(_) => "BugPlusOne",
            Step::AvoidableRectangleType1(_) => "AvoidableRectangleType1",
            Step::AvoidableRectangleType2(_) => "AvoidableRectangleType2",
            Step::XYWing(_) => "XYWing",
            Step::WWing(_) => "WWing",
            Step::SueDeCoq(_) => "SueDeCoq",
